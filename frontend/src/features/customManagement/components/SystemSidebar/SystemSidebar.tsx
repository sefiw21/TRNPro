...
import { LayoutDashboardIcon, RollerCoasterIcon, Settings2Icon, Users2Icon, type LucideIcon } from "lucide-react";
...
const SystemSidebar = () => {
    const currentNavItems: NavItem[] = [
        { icon: LayoutDashboardIcon, label: " SystemSidebar", url: "/management" },
        { icon: Users2Icon, label: " Members", url: "/management" },
        { icon: RollerCoasterIcon, label: " Roles", url: "/management" },
        { icon: Settings2Icon, label: " Settings", url: "/management" },
