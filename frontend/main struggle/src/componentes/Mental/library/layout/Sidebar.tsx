...
<section className="w-64 h-screen relative overflow-hidden rounded-2xl">
  ...
  <div className="relative z-10 h-full p-5 text-amber-50 flex flex-col">
    ...
    <div className="relative mb-6 group">
      ...
      />
      <div className="absolute inset-0 rounded-xl bg-linear-to-r from-amber-500/0 via-cyan-500/0 to-purple-500/0 
                      group-hover:from-amber-500/10 group-hover:via-cyan-500/10 group-hover:to-purple-500/10
                      transition-all duration-500 opacity-0 group-hover:opacity-100 -z-10"></div>
    </div>
        ...
        {categories.map((category, index) => (
          <label key={index} className="flex items-center group cursor-pointer">
            <div className="relative">
              ...
              />
              <div className={`w-4 h-4 border-2 rounded-full mr-3 transition-all duration-300
            ...
            <span className={`transition-all duration-300 group-hover:text-cyan-200 group-hover:translate-x-1
      ...
      <div className="grid grid-cols-2 gap-2">
        {ksewords.map((keyword, index) => (
          ...
          >
            ...
            <div className="absolute inset-0 bg-linear-to-r from-cyan-500/0 to-purple-500/0 
