...
interface SystemDetailModalProps {
    ...
    // We pass a function that fires when the user confirms they want to proceed
...
const SystemDetailModal: React.FC<SystemDetailModalProps> = ({
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm animate-in fade-in duration-200">
            {/* Modal Container */}
            <div className="w-full max-w-lg bg-white dark:bg-slate-900 oled:bg-black rounded-2xl shadow-2xl border border-slate-200 dark:border-white/10 oled:border-white/20 overflow-hidden animate-in zoom-in-95 duration-200 flex flex-col">
                ...
                <div className="overflow-y-auto p-6 space-y-6">
                    ...
                    <div className={twMerge("w-full h-32 rounded-xl bg-gradient-to-br flex items-center justify-center border border-slate-100 dark:border-white/5 oled:border-white/10", themeGradient)}>
                        {isFamily
