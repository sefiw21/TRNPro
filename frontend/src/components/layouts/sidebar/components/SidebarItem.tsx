  ...
  return (
    <NavLink
      ...
      className={({ isActive }) => twMerge(
        // The standard classes that apply to ALL items
        ...
        // Dynamic classes based on the isActive state provided by NavLink
        isActive
          ? [
            "cursor-default shadow-sm",
            "bg-blue-50/80 border-blue-200/50",
            "dark:bg-white/10 dark:border-white/10 dark:shadow-[inset_0_1px_1px_rgba(255,255,255,0.05)]",
            "oled:bg-white/10 oled:border-white/5 oled:shadow-none"
          ].join(" ")
          : [
